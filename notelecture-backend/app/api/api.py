...
from app.api import transcription, lectures, summarization, subscriptions, health, users, processor
...
router.include_router(processor.router, prefix="/processor", tags=["processor"])